...
void stby0(int a) {
  ...
  runStep(70, 110, 90, AtR[1], AbL[1], AbR[1], 15, 15, BtL[1], BtR[1], BbL[1], BbR[1], 180, 180, CtL[1], CtR[1], CbL[1], CbR[1], sp);
}
...
void mundurAction(long s, float x, float y, float z, int spid, byte nextSt) {
  left = 1; right = 1; yAxis = y; xAxis = x; zAxis = z;
  spd = spid;
  if (directionSt != 22) {
    moveToCalculation(1);
